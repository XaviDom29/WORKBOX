...
function mostrarInfo (country){
  console.log(country);
  document.querySelectorAll('#contenedor')[0].innerHTML = "<div>Name: " + country.nativeName + "</div>" +"<div>Flag: " + "<img src='country.flag'>"  + "</div>" + "<div>Calling Code: " + country.callingCodes + "</div>" + "<div>Capital: " + country.capital + "</div>"+  "<div>Population: " + country.population + "</div>"+ "<div>Gini: " + country.gini + "</div>"+ "<div>Languages: " + country.languages[0].nativeName + "</div>"+ "<div>Symbol Currencies: " + country.currencies[0].symbol + "</div>"
